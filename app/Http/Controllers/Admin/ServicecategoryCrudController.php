...
class ServicecategoryCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/servicecategory');
        $this->crud->setEntityNameStrings('servicecategory', 'servicecategories');
        ...
        */
        ...
        // add asterisk for fields that are required in ServicecategoryRequest
